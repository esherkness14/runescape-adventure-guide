...
| Combat to guild/defender/Piety | Warriors' Guild, defender, quest fights, Piety | 130 Attack+Strength; 60 Defence defender equip; 65 Defence King's Ransom; 70 Defence Piety; 50 Attack Sins | Yes | Crabs or ordinary Slayer for relaxed training | Faster Slayer/combat methods | **Skipped optional branch:** explicitly train a chosen Attack+Strength split to 130, actual 60 Defence, actual 65 Defence, then actual 70 Defence. **Completed 65/65/65 branch:** guild entry, defender equip and King's Ransom gates are already met; continue to actual 70 Defence for Piety. | Higher combat by preference | Quest bosses and later PvM | Apply MM1, Heroes, and Knight Waves rewards before calculating each manual block. The Chapter 1 optional 65/65/65 detour must never be assumed. |
...
3. **Sailing method detail:** confirm the best current low-attention mix of port tasks, charting, salvage, Tempor Tantrum, and quest XP at authoring time; the skill is new enough that rates and balance may change.
4. **Combat arithmetic:** after choosing the MM1 reward and applying Heroes/Knight Waves XP, calculate exact manual Attack/Strength/Defence stops. The route checkpoints remain 130 combined, 60 Defence, 65 Defence, then 70 Defence.
