...
| Monkey Madness I | The Grand Tree and Tree Gnome Village; combat/navigation supplies | No skill gate requiring optional melee | Mandatory Chapter 1 combat floor plus observed 2.2 quest XP | Quest infrastructure block | **Choose Daero's 35,000 Attack + Defence and 20,000 Strength + Hitpoints XP** | Dragon scimitar purchase, Awowogei RFD, later 50-Attack Iban staff and Defence gates | [Monkey Madness I](https://oldschool.runescape.wiki/w/Monkey_Madness_I) | 2026-09-24 route choice: pushes Attack over 50 from the ~46 floor after Underground Pass/Heroes and advances 60/65/70 Defence. Still verify levels; it does not supply 130 Attack+Strength or 70 Defence by itself. |
