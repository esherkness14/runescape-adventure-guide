...
| **2.6 — The 70s: Song of the Elves Preparation** | Close every missing exact skill gate without optional assumptions. | Actual 70 Agility, Construction, Farming, Herblore, Hunter, Mining, Smithing, and Woodcutting; **Making Friends with My Arm** after its 68 Agility/72 Mining checks; 60 Ranged for MEPI already scheduled; adequate quest supplies. | 72 Agility/floor 3; 73 Construction or other incidental targets; 84/98 Agility. |
...
| Recruitment Drive/Wanted!/Slug Menace, Temple of the Eye, Enakhra's Lament, Spirits of the Elid, Icthlarin's Little Helper, Contact!, Scorpion Catcher, Ghosts Ahoy, Zogre Flesh Eaters | 2.5 or later named prerequisite batches | One Small Favour and Big Chompy are now explicitly complete in 2.4. Retain these other quests only where they feed a named later chain or unlock; do not preserve source zig-zagging by default. |
...
| King's Ransom | 45 Magic and **65 Defence**, plus Black Knights' Fortress, Holy Grail/Merlin's Crystal, Murder Mystery, One Small Favour | Not boostable | 65+ Magic / 60 Defence | Explicit 60→65 Defence and quest spine | Opens Knight Waves | Piety path | [King's Ransom](https://oldschool.runescape.wiki/w/King%27s_Ransom) | Verified 2026-09-24. **2.5 must explicitly complete Black Knights' Fortress** before this quest; Holy Grail was done in 1.3 and Murder Mystery/One Small Favour in 2.4. Do not accidentally assume the optional Recruitment Drive/Wanted! chain did it. |
...
| 70 Herblore | Actual 40 handoff plus **20,000 guaranteed XP from both One Small Favour lamps** in 2.4; 50 needed in 2.5 | Kingdom/herb runs start early; reserve RFD's bankable 20,000-XP lamp for Herblore after 50 unless final budget proves another bottleneck | Full Legends and other later selectable lamps only when actually earned | Herb runs, kingdom herbs, make useful potions | More frequent runs/resource processing | Verified gate; **open exact budget**. Final page plan must reconcile herbs, secondaries, quest rewards, and lamp allocations. |
...
| 70 Mining | Actual 60 after 2.4 Lunar; target actual 72 before Making Friends if following the recommendation | Train from 60 toward 70 SotE, then 72 for a boost-free Making Friends (or boost its 72 gate) | Quest rewards observed at each stage | Motherlode Mine, shooting stars, or calcified deposits | Sandstone/granite or Volcanic Mine when prerequisites/team fit | Verified 2026-09-24. 72 already exceeds SotE; do not pull this into 2.4. |
...
| --- | --- | --- | --- |
| Making Friends with My Arm | 68 Agility and 72 Mining (boostable), 66 Firemaking and 35 Construction, plus Swan Song, Cold War and My Arm's Big Adventure | 2.4 completes all named quests; 2.6 skilling block closes/boosts Agility and Mining | **Mandatory here**, optional early after Swan Song only if already comfortable. Rewards 50,000 Agility XP, 50,000 Mining XP, 40,000 Firemaking XP, 10,000 Construction XP and the disease-free Weiss herb patch; count the XP only after completion. |
