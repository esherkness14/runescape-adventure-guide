...
| --- | ---: | --- |
| Attack / Strength / Defence | 46 / 50 / 34 | The optional 60/60/60 block is never assumed. |
...
| Agility | 98 | 70 | Exact 70 is SotE; 72/82/92 are optional Sepulchre access tiers. |
...
3. **Agility stops at an actual 70 for Song of the Elves.** Use 52 for Sins, a boost at 63/65 for Making Friends with My Arm if desired, and exact unboosted 70 for Song of the Elves. Sepulchre 84/98 is optional; its floors cannot be boosted.
...
9. **The live BRUHsailer claim that an Agility boost grants early Sepulchre floor access is stale.** Floor thresholds are unboostable; plan around actual 52/62/72/82/92.
...
| **2.2 — Quest Infrastructure** | Build the transport, weapon, kingdom-prerequisite, and quest-point spine. | Underground Pass/Iban, Shilo, Dorgesh-Kaan access, Between a Rock, Family Crest, Heroes, Monkey Madness I, and required supporting quests complete; actual 50 Smithing where needed. | Opportunistic diaries and geographic multi-questing. |
| **2.3 — Sailing, Combat & the Kingdom** | Start passive kingdom resources, teach Sailing, and establish first ship tiers. | Throne of Miscellania/Royal Trouble; Sailing through 45; clear statement that 51 Slayer gates Troubled Tortugans. | Barbarian Assault comfort unlocks; Sailing continuation only if Slayer was moved forward. |
...
| Dragon Slayer I, Bar Crawl/Barbarian Training, basic diaries already completed in the Intermediate route | Treat this repository's Chapter 1 as authoritative | Do not replay a BRUHsailer step merely because its current Chapter 2 source still contains it. |
| Underground Pass/Iban upgrade; Between a Rock; Heroes; Shilo; Death to the Dorgeshuun/Another Slice; Tears of Guthix; Family Crest; Monkey Madness I; Haunted Mine | 2.2 infrastructure | Retain the unlock/prerequisite spine. Group into coherent quest inventories; diary coincidences are secondary. |
| Recruitment Drive/Wanted!/Slug Menace, One Small Favour, Temple of the Eye, Enakhra's Lament, Spirits of the Elid, Icthlarin's Little Helper, Contact!, Scorpion Catcher, Ghosts Ahoy, Big Chompy, Zogre Flesh Eaters | 2.2 or 2.4 prerequisite batches | Retain where they feed Initiate/Proselyte, RFD, Lunar, later quest chains, or route travel. Verify inventories per quest; do not preserve source zig-zagging by default. |
...
| Pandemonium, Prying Times, Current Affairs, charting/port tasks, ship upgrades, Tempor Tantrum | 2.3 Sailing primer through 45 | Retain. Explain the systems rather than copying coordinate-by-coordinate routing. |
...
| Adept Mahogany Homes contracts | 50 Construction | Visible boosts can enter some content, but use actual 50; crystal saw does not obtain contracts | 39 | Early teak/plank preparation and ordinary/Mahogany Homes training | Contract XP varies by layout; do not promise BRUHsailer's exact level | Points and relaxed Construction progression | [Adept contract](https://oldschool.runescape.wiki/w/Adept_contract) | Verified 2026-09-24. |
| Plank sack | 350 Mahogany Homes points | No | 0 points expected | 88 adept contracts × 4 points = 352 | Contract XP should put the account near the lectern base target, but verify | Useful for later contracts and the source macro plan | [Mahogany Homes Rewards](https://oldschool.runescape.wiki/w/Mahogany_Homes_Reward_Shop) | Verified/derived 2026-09-24. Exactly 88 assumes every contract is adept and completed for full points. |
...
| Between a Rock... | 30 Defence, 40 Mining, 50 Smithing | Mining/Smithing are boostable, but route should train actual 50 Smithing | 34 Defence / 44 Mining / 42 Smithing | Early Smithing block; existing Defence/Mining | Quest XP is helpful but not the reason for 50 | Gold-mining/quest spine; Heroes prerequisite context | [Between a Rock...](https://oldschool.runescape.wiki/w/Between_a_Rock...) | Verified 2026-09-24. |
| Heroes' Quest | 55 quest points; 53 Cooking, 53 Fishing, 25 Herblore, 50 Mining; Shield of Arrav, Lost City, Merlin's Crystal, Dragon Slayer I | Listed skills are boostable, but only Mining needs attention if still below 50 | 60 Cooking / 74 Fishing / 40 Herblore / 44 Mining | Train/boost Mining to 50; quest backbone | About 3,075 each Attack/Defence/Strength/HP plus smaller Fishing, Cooking, Smithing, Mining, Herblore rewards | Throne of Miscellania, dragon weapons, later quests | [Heroes' Quest](https://oldschool.runescape.wiki/w/Heroes%27_Quest) | Verified 2026-09-24. Use the current partner system instructions. |
| Monkey Madness I | The Grand Tree and Tree Gnome Village; combat/navigation supplies | No skill gate requiring optional melee | Chapter 1 combat or explicit catch-up | Quest infrastructure block | Chosen combat reward can add Attack/Defence XP; record the selected reward | Dragon scimitar and Awowogei RFD prerequisite | [Monkey Madness I](https://oldschool.runescape.wiki/w/Monkey_Madness_I) | Verified 2026-09-24. Do not turn its reward into an invisible later assumption. |
| Family Crest | 40 Mining, 40 Smithing, 59 Magic, 40 Crafting | Skill boosts allowed, but all already met except no issue | 44 / 50 / 63 / 56+ | Chapter 1 plus Between a Rock prep | Gauntlet access | Utility and source quest spine | [Family Crest](https://oldschool.runescape.wiki/w/Family_Crest) | Verified 2026-09-24. |
| Legends' Quest access/completion | 107 quest points; 50 Agility, Crafting, Strength, Thieving, Woodcutting; 45 Herblore; 56 Magic; 52 Mining; 42 Prayer; 50 Smithing plus quest chain | Skills are generally boostable where the quest permits, but route should own the common 50s | Most met; Herblore 40, Mining 44, Smithing target 50 | Quest rewards and visible skill catch-ups | Reward lamps must have a named allocation | Sir Amik RFD prerequisite and further quest backbone | [Legends' Quest](https://oldschool.runescape.wiki/w/Legends%27_Quest) | Verified 2026-09-24. Herblore is the preferred lamp sink unless the final budget shows otherwise. |
...
| Prying Times | 12 Sailing, 30 Smithing | Sailing not boostable; Smithing already met | 12 / 50 | Port tasks/charting; 2.2 Smithing | 800 Sailing XP | Sailing quest progression | [Sailing training](https://oldschool.runescape.wiki/w/Sailing_training) | Verified 2026-09-24. |
...
| Teak hull tier | 31 Sailing and 23 Construction to build the upgrade | Sailing not boostable; shipwright purchase may replace some Construction building | 31 / 50+ | Sailing loop; 2.1 Construction | Better ship progression | Route to 45 and later sea content | [Sailing level-up table](https://oldschool.runescape.wiki/w/Sailing/Level_up_table), [Shipbuilding](https://oldschool.runescape.wiki/w/Shipbuilding) | Verified 2026-09-24. Explain build-versus-shipwright choice. |
...
| Lunar Diplomacy | 5 Herblore, 61 Crafting, 40 Defence, 49 Firemaking, 65 Magic, 60 Mining, 55 Woodcutting; Fremennik Trials, Lost City, Rune Mysteries, Shilo Village | Required skill levels are not boostable | Crafting 61+ after staves; Defence must be trained to 40; Magic 65 after alchs; Mining needs 60; others met | 2.1 stave block, explicit Defence/Mining, 2.2 Shilo | Quest rewards and Lunar spellbook | Utility magic and later quest backbone | [Lunar Diplomacy](https://oldschool.runescape.wiki/w/Lunar_Diplomacy) | Verified 2026-09-24. Add explicit 63→65 Magic and 44→60 Mining if not already supplied. |
...
| Full Recipe for Disaster | 175 quest points and all subquests; aggregate notable gates include 70 Cooking, 48 Agility, 50 Mining, 53 Fishing, 53 Thieving, 25 Herblore, 59 Magic, 40 Smithing, 50 Firemaking, 40 Ranged, 40 Crafting, 10 Fletching, 10 Slayer, 36 Woodcutting | Varies by subquest; do not use boosts to hide route holes | All met after named 2.2–2.4 checkpoints | Quest spine and explicit Cooking | Barrows gloves | Major combat/utility upgrade and future baseline | [Recipe for Disaster](https://oldschool.runescape.wiki/w/Recipe_for_Disaster) | Verified 2026-09-24. Audit quest items per subquest when authoring inventories. |

### 2.5 — Defender, Piety & Morytania

| Gate / activity | Exact requirement | Boostable? | Expected before | Mandatory supplier | Relevant XP / incidental output | Downstream reason | Source | Status / notes |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Warriors' Guild entry | Attack + Strength ≥130, or 99 in either | No | 46/50 unless player took optional training | Explicit proposed 60 Attack / 70 Strength training | Combat XP only | Defender progression | [Warriors' Guild](https://oldschool.runescape.wiki/w/Warriors%27_Guild) | Verified 2026-09-24. 60/70 is a useful route checkpoint, not the only valid split. |
...
| --- | ---: | --- | --- | --- | --- | --- |
| 70 Agility | 52+, perhaps 63/65 for Making Friends; exact value varies with quests/optional barb fishing | Dedicated training before 2.7; stop at actual 70 | Ordinary Barbarian Fishing and Making Friends reward | Seers rooftop or Colossal Wyrm course; choose based on attention/rewards | Hallowed Sepulchre floors actually unlocked | Verified 2026-09-24. Exact 70 is SotE; 72 only opens Sepulchre floor 3. |
...
| Hallowed Sepulchre to 84, later 98 | Agility, Thieving/Construction/Prayer/Ranged interactions, loot, prayer supplies, alchables | 52 Sins; 68 Making Friends boostable; exact 70 SotE. No identified Ch. 3 quest exceeds 70 | Yes; loot/resources have other suppliers | Seers rooftop or Colossal Wyrm course; Sepulchre only to an enjoyed cutoff | Efficient Sepulchre laps | **Actual 70 Agility** | 72 floor 3, 82 floor 4, 92 floor 5; 84/98 efficiency branches | Prif course at 75; resource stock; future maxing | Current floors are exact 52/62/72/82/92 and **not boostable**. BRUHsailer's early floor-4 boosting instruction is stale. |
...
| Combat to guild/defender/Piety | Warriors' Guild, defender, quest fights, Piety | 130 Attack+Strength; 60 Defence defender equip; 65 Defence King's Ransom; 70 Defence Piety; 50 Attack Sins | Yes | Crabs or ordinary Slayer for relaxed training | Faster Slayer/combat methods | **Proposed 60 Attack / 70 Strength, then actual 70 Defence** | Higher combat by preference | Quest bosses and later PvM | Apply MM1, Heroes, and Knight Waves rewards before calculating each manual block. Optional Ch. 1 60/60/60 must not be assumed. |
...
| Conflict | Resolution |
| --- | --- |
| BRUHsailer text implies boosting into a higher Hallowed Sepulchre floor. | Current floor access thresholds are 52/62/72/82/92 Agility and are not boostable. Use current mechanics; BRUHsailer's instruction is stale. |
...
## Open decisions before authoring pages
...
2. **Construction 2.1 quantities:** simulate the exact contract/plank count from the real starting XP. “88 adept contracts” guarantees sack points but contract layouts vary, so it does not alone prove the final level. Confirm the precise base level and kitchen tea setup used for the +5 lectern build.
3. **Sailing placement:** recommended resolution is 1→45 in 2.3, then Tortugans and 45→67 after 51 Slayer in 2.5. Decide whether the latter is a 2.5 closing block or a short named lane in 2.6.
4. **Sailing method detail:** confirm the best current low-attention mix of port tasks, charting, salvage, Tempor Tantrum, and quest XP at authoring time; the skill is new enough that rates and balance may change.
5. **Combat arithmetic:** after choosing the MM1 reward and applying Heroes/Knight Waves XP, calculate exact manual Attack/Strength/Defence stops. The route checkpoints remain 130 combined, 60 Defence, 65 Defence, then 70 Defence.
6. **Dragon/Prayer budget:** at the actual checkpoint, record current Prayer XP, banked bones, guaranteed quest rewards still ahead, Chaos Altar risk tolerance, and buffer policy. Do not publish “kill 1,300” as a universal instruction.
7. **Optional Chapter 3-prep quests:** decide whether Path of Glouphrie/Curse of Arrav/Defender of Varrock stay late in Chapter 2. If retained, add their exact gates (including any 56 Slayer or 62 Ranged requirement) to the mandatory route; otherwise place an explicit Chapter 3 catch-up.
8. **Thieving 78 diary step:** either demonstrate enough guaranteed XP and create a checkpoint, or defer the step. It is not needed by the core route.
9. **RFD inventory audit:** requirements are mapped, but each subquest's one-off items and the 175-QP schedule need a page-level preflight once the full quest order is frozen.
