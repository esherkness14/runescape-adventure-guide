# Intermediate Ironman Guide — Chapter 1 → Chapter 2 boundary audit

Audit basis: BRUHsailer current guide (updated 2026-08-30) plus current OSRS Wiki requirements/mechanics checked during this pass.
...
- 15 salmon reserved for the Myreque quest chain.
- Heavy fishing rod retained from Barbarian Training.
- Kharedst's memoirs retained.
...
- Fossil Island and hardwood patches.
- Fairy rings.
- Ancient Magicks from Desert Treasure.
- Paddewwa teleport tablets.
- Kharedst's memoirs teleport network.
- Balloon transport from Enlightened Journey.
- Digsite pendants, rings of dueling and games necklaces.
- 100+ Varrock Museum Kudos/Bone Voyage foundation.
- The Fremennik Trials and the Chapter 1 Fremennik/Troll quest foundation.
...
BRUHsailer Chapter 2 is much more EHP-heavy than the intended Intermediate guide. The rewrite should preserve the dependency order but deliberately replace or soften these assumptions:
